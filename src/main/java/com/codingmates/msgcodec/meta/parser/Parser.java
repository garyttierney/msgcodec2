...
public final class Parser implements Closeable {
	...
	/**
	 * Ensures the {@link #current} {@link Token} has the specified {@link Token.Type} and one of the specified properties.
	 *
	 * @param type The expected {@link Token.Type} of the {@link #current} {@link Token}. Must not be {@code null}.
	 * @param values The accepted properties of the {@link #current} {@link Token}. Must not be {@code null}.
	...
	/**
	 * Parses an {@link UnresolvedAttributeProperty}. Expects a key-value format, allowing properties
